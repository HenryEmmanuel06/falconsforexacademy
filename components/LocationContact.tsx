                        ...
                        <div className="">
                            ...
                            <div className="grid pt-[20px] gap-[20px] grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
                               ...
                               <div className="flex items-start gap-[5px]">
                                    ...
                                    <div className="max-w-[204px]">
                                        <p className="text-[#535862] text-[16px] font-normal"><span className="inline-block font-bold">Closing Time: </span> <span className="block"> 4pm prompt</span></p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-[5px]">
                                    ...
                                    <div className="max-w-[204px]">
                                        <p className="text-[#535862] text-[16px] font-normal"><span className="inline-block font-bold">Contact:  </span> +2349066555596 <br />+2348036593242</p>
                                    </div>
                                </div>
